...
(function (Controllers) {
    class GitlabController extends controller.Controllers.Core.Controller {
        constructor() {
            super();
        ...
        user(req, res) {
            ...
            if (!req.isAuthenticated()) {
                ...
                return WorkspaceService.workspaceAppFromUserId(userId, this.config.appName)
                    .flatMap(response => {
                    if (!response) {
                        return rxjs_1.throwError('no workspace app found');
                    }
        ...
        projectsRelatedRecord(req, res) {
            ...
            if (!req.isAuthenticated()) {
                ...
                return WorkspaceService.workspaceAppFromUserId(userId, this.config.appName)
                    ...
                    return rxjs_1.Observable.merge(...obs);
                })
                    .subscribe(response => {
        ...
        updateProject(req, res) {
            ...
            if (!req.isAuthenticated()) {
                ...
                const creation = req.param('creation');
                const project = {};
                const projectId = creation.group.path + '/' + creation.template.name;
